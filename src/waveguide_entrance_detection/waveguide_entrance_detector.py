...
#
#     image_gu = prepare_image(image)
#
#     horizontal_edge_chip, vertical_edge_chip = detect_edges(image_gu)
#
#     ROI_image, ROI_bbox, ROI_corners, intersection_edge_point = get_ROI(horizontal_edge_chip, vertical_edge_chip,
#                                                                         image_gu)
#
#     left_vertical_line, right_vertical_line = detect_waveguide_lines(ROI_image)
#
#     left_OS_vertical_line, right_OS_vertical_line, waveguide_entrance_coordinates = get_waveguide_entrance(
#         horizontal_edge_chip, left_vertical_line, right_vertical_line, ROI_bbox)
#
#     image_with_drawings = draw_all_on_image(image_gu, horizontal_edge_chip, vertical_edge_chip, intersection_edge_point,
#                                             ROI_corners, [left_OS_vertical_line, right_OS_vertical_line],
#                                             waveguide_entrance_coordinates)
#
#     visualize_image(image_with_drawings)
#
